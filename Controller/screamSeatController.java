...
public class screamSeatController {
...
public void go2Ticket(ActionEvent event) {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/screamConfirm.fxml"));

        Parent root = loader.load();
        screamConfirmController ticketController = loader.getController();
