...
public class ponyogcashController {
    ...
    @FXML
    private Button toticket, selectedTimeLabel;
    ...
    public void toTicket(ActionEvent event) {
        ...
        if (enteredNumber.equals(predefinedNumber) &&
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ponyoTix.fxml"));
                Parent root = loader.load();
                ponyoTixController ticketController = loader.getController();
